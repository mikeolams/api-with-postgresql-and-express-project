...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error(" Could not list users: ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error(" Could not list these users: ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt.hashSync(u.password + pepper, 
                        //@ts-ignore 
                        parseInt(saltRounds));
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error(" Could not add user ".concat(u.firstName, ": ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.authenticate = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var username, conn, sql, result, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
